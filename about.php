            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb_iner">
                        <h2 style="text-shadow: black 0.1em 0.1em 0.2em">Thông tin chính của website</h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="about_us_content">
                        ...
                        <h3>trang web được thành lập vào ngày 7-11-2023. Wedsite được xây dựng trên nền code HTML, CSS, Javascript, PHP, Jquery. Wedsite gồm có các trang như là: Trang chủ, Trang thông tin, Trang sản phẩm, Trang Bài Đăng, Trang Đăng ký, Đăng
                            nhập
                        </h3>
                    </div>
                </div>
